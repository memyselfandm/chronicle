...
class DatabaseManager:
    """Minimal database manager for subagent stop events."""
        ...
        try:
            ...
            return {
                ...
                "hookSpecificOutput": {
                    ...
                    "performanceRating": lifecycle_analysis["performance_rating"],
                    "cleanShutdown": exit_reason in ["completed", "success", "normal"],
                    "eventSaved": event_saved
                }
            }
            
        except Exception as e:
            logger.debug(f"Subagent stop hook error: {e}")
            return {
                "continue": True,
                "suppressOutput": True,
                "hookSpecificOutput": {
