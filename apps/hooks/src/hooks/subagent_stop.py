        ...
        try:
            ...
            event_data = {
                "event_type": "subagent_stop",
                     # Changed from "subagent_termination" as per requirements
                ...
                "data": {
                    ...
                    "resource_cleanup": {
                        ...
                        "clean_shutdown": exit_reason in ["completed",
                            "success", "normal"]
                    }
                }
            }
...
def main():
    ...
    try:
        ...
        duration_ms = input_data.get("durationMs", 0)
        logger.info(
            f"Subagent termination - ID: {subagent_id}, Type: {subagent_type}, Exit: {exit_reason}, Duration: {duration_ms}ms")
