...
class ChronicleDashboard {
    ...
    toggleTimeline() {
        ...
        toggleBtn.querySelector('.material-icons').textContent = 
            this.state.timelineCollapsed ? 'visibility_off' : 'visibility';
    }
    ...
    clearAllFilters() {
        ...
        document.getElementById('eventTypeFilter').selectedIndex = -1;
        document.getElementById('sessionFilter').selectedIndex = -1;
    ...
    toggleEventTypeFilter(index) {
        ...
        if (select.options[index]) {
            ...
            this.updateEventTypeFilter(select);
        }
    }
